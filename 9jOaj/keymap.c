...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    TD(DANCE_0),    KC_Z,           KC_X,           KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_CAPS,        
  ...
  [2] = LAYOUT_voyager(
    ...
    TG(3),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TG(3),          
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   KC_GRAVE,       KC_TILD,        KC_LCBR,        KC_RCBR,        KC_PIPE,                                        KC_TRANSPARENT, KC_PLUS,        KC_ASTR,        KC_TRANSPARENT, KC_BSLS,        KC_F12,         
  ...
  [6] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MINUS,       KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_DOT,         KC_BSLS,        KC_F12,         
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [3] = { {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255}, {0,194,255} },
